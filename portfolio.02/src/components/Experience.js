  ...
  return (
    <section id="experience" className="text-gray-400 body-font">
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        ...
        <div className="hidden sm:block sm:invisible mt-4 lg:mr-5 md:mr-5">
        ...
        <div className="h-[50%] mt-[20%] hidden sm:flex flex-cols items-end">
        ...
        <div className="w-[100%] lg:w-[50%] md:w-[50%] lg:h-[650px] md:h-[650px] lg:mt-0 md:mt-0 mt-4 lg:ml-5 md:ml-5 flex flex-cols items-end">
          <div className="hidden sm:flex lg:mr-5 md:mr-5">
        {flocco ? <div className="border w-full p-5 rounded-xl">
          <p className="text-left leading-relaxed">
